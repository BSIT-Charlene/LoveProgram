  ...
  <div class="page-section">
    ...
    <div class="col login-side">
      <div class="logo-container">
        <img src="./img/green-logo.jpg" alt="">
      </div>
      ...
      <form action="" method="POST">
        <div class="input">
          <div class="row username-row">
            <span>Username</span>
            <span class="wrong-user <?php if (isset($showWrongUserClass) && $showWrongUserClass) echo 'show'; ?>">User is not registered</span>
          </div>
          <div class="row">
